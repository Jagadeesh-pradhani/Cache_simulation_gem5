...
# gem5/build/X86/gem5.opt gem5/configs/deprecated/example/se.py --cmd=/home/jagadeesh/Cache_simulation/gem5/tests/test-progs/hello/bin/x86/linux/hello -n 4 --num-dirs=4 --ruby --network=garnet --topology=Mesh_XY --mesh-rows=2 --link-latency=1 --router-latency=1 --cpu-type=TimingSimpleCPU --l1d_size=64kB --l1i_size=64kB --l2_size=512kB
