...
for i in range(n):
      system.cpu[i].icache = L1ICache(prefetcher = StridePrefetcher())
      system.cpu[i].dcache = L1DCache(prefetcher = StridePrefetcher())
...
system.l2cache = L2Cache(prefetcher = StridePrefetcher())
