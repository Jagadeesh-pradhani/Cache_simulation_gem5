...
!$OMP PARALLEL DO DEFAULT(SHARED) PRIVATE(TMP,M,I,J,K)
      do k = 1, nz
         do j = 1, ny
            do i = 1, nx
               do m = 1, 5
...
!$OMP PARALLEL DO DEFAULT(SHARED) PRIVATE(U51IM1,U41IM1,U31IM1,U21IM1,
!$OMP& U51I,U41I,U31I,U21I,TMP,M,Q,U21,FLUX,I,J,K)
      do k = 2, nz - 1
         do j = jst, jend
            do i = 1, nx
               flux(1,i) = u(2,i,j,k)
...
c---------------------------------------------------------------------
!$OMP PARALLEL DO DEFAULT(SHARED) PRIVATE(U51JM1,U41JM1,U31JM1,U21JM1,
!$OMP& U51J,U41J,U31J,U21J,TMP,M,Q,U31,FLUX,J,I,K)
      do k = 2, nz - 1
         do i = ist, iend
            do j = 1, ny
               flux(1,j) = u(3,i,j,k)
...
c---------------------------------------------------------------------
!$OMP PARALLEL DO DEFAULT(SHARED) PRIVATE(U51KM1,U41KM1,U31KM1,U21KM1,
!$OMP& U51K,U41K,U31K,U21K,TMP,M,Q,U41,FLUX,K,I,J,utmp,rtmp)
      do j = jst, jend
         do i = ist, iend
      	    do k = 1, nz
	       utmp(1,k) = u(1,i,j,k)
