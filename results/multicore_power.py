...
def main(x_label, plot_label, convert):
    ...
    for core_id in range(16):
        metrics.append(f"system.mem_ctrls{core_id}.dram.rank0.averagePower")  # L1D misses for each core
        metrics.append(f"system.mem_ctrls{core_id}.dram.rank1.averagePower")  # L1I misses for each core
